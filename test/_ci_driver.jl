...
function _scaffold_testset()
    @testset "Jimm scaffold" begin
        ...
        @test isdefined(Jimm.Models, :_load_bit_resnetv2)
        ...
        @test isdefined(Jimm.Models, :_load_resnet)
        ...
        @test isdefined(Jimm.Models, :_load_convnextv2)
        ...
        @test isdefined(Jimm.Models, :_load_convnext)
        @test isdefined(Jimm.Models, :CONVNEXT_VARIANTS)
        @test isdefined(Jimm.Models, :create_model)
        @test isdefined(Jimm.Models, :create_pretrained)
        @test isdefined(Jimm.Models, :default_num_classes)
        @test isdefined(Jimm.Models, :_load_pretrained)
    end
end
